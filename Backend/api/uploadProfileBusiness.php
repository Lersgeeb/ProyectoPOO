                ...
                if($tokenfromDb == $_COOKIE['token']){
                    if(isset($_FILES["image"])){
                        ...
                        if($name && $tempFilePath){
                            $path = '../../Frontend/img/imgBusiness/'. $_POST['nameFile'] . '.jpg';
                            move_uploaded_file($tempFilePath, $path);
                            $newPath = '../img/imgBusiness/'. $_POST['nameFile'] . '.jpg';
                            Business::changePathProfileImg($database->getDatabase(), $_COOKIE['key'], $newPath);
                            echo $newPath;
                        }
